  ...
  return <section id="support" className="py-20 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-8 md:px-12">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.h2 className="text-3xl md:text-4xl font-bold text-sofitel-navy mb-4" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
          ...
          <motion.p className="text-lg text-sofitel-charcoal/70" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          <motion.div className="lg:col-span-3 space-y-8" initial={{
          opacity: 0,
          x: -20
        }} whileInView={{
          opacity: 1,
            ...
            <div className="bg-white rounded-2xl shadow-card overflow-hidden border border-gray-100">
              <div className="p-8">
                ...
                <div className="space-y-4">
                  {faqs.map((faq, index) => <div key={index} className="border-b border-gray-100 last:border-0 pb-4 last:pb-0">
                      <button className="flex justify-between items-center w-full text-left py-3" onClick={() => toggleFaq(index)}>
                        <span className="font-medium text-sofitel-navy">{faq.question}</span>
                        {openFaqIndex === index ? <ChevronUp size={18} className="text-sofitel-navy/70" /> : <ChevronDown size={18} className="text-sofitel-navy/70" />}
                      </button>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-card border border-gray-100">
              ...
              <form onSubmit={handleContactSubmit} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <input type="text" id="name" name="name" value={contactForm.name} onChange={handleContactChange} required className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-sofitel-navy/30 focus:border-sofitel-navy transition-all" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input type="email" id="email" name="email" value={contactForm.email} onChange={handleContactChange} required className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-sofitel-navy/30 focus:border-sofitel-navy transition-all" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input type="tel" id="phone" name="phone" value={contactForm.phone} onChange={handleContactChange} className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-sofitel-navy/30 focus:border-sofitel-navy transition-all" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea id="message" name="message" value={contactForm.message} onChange={handleContactChange} required rows={4} className="w-full px-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-sofitel-navy/30 focus:border-sofitel-navy transition-all resize-none" />
                </div>
                
                <motion.button type="submit" className="w-full py-3 px-6 rounded-lg bg-sofitel-navy hover:bg-sofitel-navy/90 text-white font-medium shadow-md hover:shadow-lg transition-all" whileHover={{
                scale: 1.02
              }} whileTap={{
                scale: 0.98
              }}>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex space-x-3">
                  ...
                  <div>
                    ...
                    <a href="https://www.sofitel-frankfurt.com" target="_blank" rel="noopener noreferrer" className="text-sm text-sofitel-navy hover:underline">sofitelhoteljobs.works</a>
                  </div>
                </li>
              </ul>
            </div>
