...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-sofitel-navy text-white py-12 px-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a 
                href="#" 
                className="text-white/80 hover:text-white transition-colors text-sm inline-block after:content-[''] after:block after:w-0 after:h-[1px] after:bg-white after:transition-all hover:after:w-full"
              >
                {t('faqs')}
              </a>
            </li>
