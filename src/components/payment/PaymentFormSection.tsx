        ...
        <div>
          ...
          <div className="p-6 border border-gray-100 rounded-xl bg-sofitel-cream/30 mb-6">
            ...
            <ul className="text-sm text-sofitel-charcoal/80 space-y-2 list-disc pl-5">
              ...
              <li>You make partial payments of €500 each (approximately UGX 1,991,000)</li>
          ...
          <motion.button onClick={handlePartialPaymentClick} className="w-full py-4 px-6 rounded-lg bg-sofitel-navy hover:bg-sofitel-navy/90 text-white font-medium shadow-md hover:shadow-lg transition-all flex items-center justify-center space-x-2" whileHover={{
          scale: 1.02
        }} whileTap={{
          scale: 0.98
        }}>
